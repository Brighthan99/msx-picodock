...
"""disk_put.py - copy files into an MSX disk image, without mounting it.
    ...
    ./src/host/disk_put.py <image> <file-or-dir> [more...]

    ./src/host/disk_put.py picodock.img GAME.ROM
    ./src/host/disk_put.py picodock.img ~/msx/SOFARUN      # -> A:\\SOFARUN\\
    ./src/host/disk_put.py picodock.img ~/msx/SOFARUN/*    # -> A:\\ (root)
