...
"""disk_rm.py - remove files or folders from an MSX disk image, without mounting.
    ...
    ./dist/disk/tools/disk_rm.py <image> <name> [more...]

    ./dist/disk/tools/disk_rm.py picodock.img OLD.ROM
    ./dist/disk/tools/disk_rm.py picodock.img PDKEY.COM PDMON.COM
    ./dist/disk/tools/disk_rm.py picodock.img SOFARUN          # a folder and its contents
