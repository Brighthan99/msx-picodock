...
"""pd_diskserver.py - serve a disk image to the MSX as a hard disk (D4b).
    ...
    ./dist/disk/tools/pd_diskserver.py msxdisk.dmg
    ./dist/disk/tools/pd_diskserver.py msxdisk.dmg --readonly
...
Create an image with ./dist/disk/tools/make_disk.sh.
...
def main():
    ...
    if not os.path.isfile(args.image):
        sys.exit(f"[-] no such image: {args.image}\n"
                 f"    create one with: ./dist/disk/tools/make_disk.sh")
